        ...
        {gameResult.week < 0 &&
            <div>
                ...
                <p>
                    ...
                    на каждом этапе.<br/>
                    Завершенные задачи начинают приносить еженедельную прибыль, указанную на карточке.<br/>
                    Себестоимость - это сумма числа часов каждого этапа умноженные на стоимость нормочаса каждого этапа.<br/>
                    Сотрудники на окладах. Платить им придётся, даже если они филонят (деньги на зарплату есть, даже пока вы в минусе).
                </p>
                <p>
                    Пока задачу никто не взял в работу вы можете кнопками управления перемещать задачи:
                    <ul>
                        <li>поднимать и опускать задачи в приоритете (чем выше, тем раньше её возьмут в работу)</li>
                ...
                <p>
                    Отчет команда приносит каждую неделю. Тогда же можно пересмотреть приоритеты не взятых в работу задач.
                </p>
                <p>
                    Ваша задача заработать как можно больше денег за полгода разработки.
                    Тем более, что через полгода наступит пора заплатить <strong>70&nbsp;000 coin</strong> за аренду
                    помещения.
                    Но так как это стартап, далеко не факт, что вы сможете выйти в плюс за такой короткий период.
                </p>
                <p>
                    Успехов!
                </p>
