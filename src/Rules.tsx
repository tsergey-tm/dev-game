        ...
        <div className={"RulesInnerBlockContextBlock"}>
            ...
            <div className={"RulesInnerBlockContextBlockText"}>
                <p>
                    ...
                    Себестоимость&nbsp;— это сумма часов этапа, умноженная на&nbsp;стоимость нормочаса.<br/>
                    На&nbsp;сложном уровне к&nbsp;себестоимости прибавляется стоимость лицензии,
                    которую мы&nbsp;продаём клиенту вместе с&nbsp;продуктом.
                    Стоимость лицензии мы&nbsp;выплачиваем нашему поставщику в&nbsp;момент,
                    когда получили оплату от&nbsp;клиента.<br/>
